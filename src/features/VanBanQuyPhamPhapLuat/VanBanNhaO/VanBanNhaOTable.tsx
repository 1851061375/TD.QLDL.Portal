...
import { VanBanNhaODetail } from "./VanBanNhaODetail";
import { useSeachContext } from "@/features/portal/home/SearchContext";
import { DownloadOutlined } from '@ant-design/icons';



export const VanBanNhaOTable = () => {
    ...
    return (
        <>
            <TableList
                ...
                loading={loading}
            />
            {chiTietModal ? <VanBanNhaODetail id={id} chiTietModal={chiTietModal} setChiTietModal={setChiTietModal} ></VanBanNhaODetail> : <></>}
        </>
