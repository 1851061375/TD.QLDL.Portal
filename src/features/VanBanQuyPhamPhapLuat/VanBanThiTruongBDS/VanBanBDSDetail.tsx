...
export const VanBanBDSDetail: FC<Props> = ({ id, chiTietModal, setChiTietModal }) => {
    ...
    return (
        <AntdModal title="Chi tiết văn bản quy phạm pháp luật thị trường BĐS" visible={true} handlerCancel={handleCancel} footer={null}>
            <Form name='VanBanBDS' layout="vertical" onFinish={onFinish} form={form} initialValues={{ thuTu: 1 }}>
                <Row gutter={[8, 8]}>
                    <Col md={12} span={24}>
                        <Form.Item
                            label="Số ký hiệu"
