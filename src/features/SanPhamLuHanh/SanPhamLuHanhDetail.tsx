...
import {
    ...
    Button, Row, Col, List, message, Spin, Space,
    Descriptions
} from 'antd';
    ...
    useEffect(() => {
        const fetch = async () => {
            ...
            if (loaisanphamluhanhid) {
                var similarRes = await fetchSimilarData(loaisanphamluhanhid, id);
                    ...
                    <Space direction="vertical" size="middle" style={{
                        ...
                        <Row gutter={[16, 16]}>
                            <Col xs={24} sm={24} md={12}>
                                ...
                                <SlideImage images={[state.coverUrl]} />
                            </Col>
                            <Col xs={24} sm={24} md={12}>
                                <Card style={{ maxHeight: '400px' }} className="shadow-sm">
                                    ...
                                    <Descriptions bordered column={1}>
                                        <Descriptions.Item label="Loại sản phẩm">{state.item?.LoaiSanPhamLuHanhText}</Descriptions.Item>
...
export default SanPhamLuHanhDetail;
